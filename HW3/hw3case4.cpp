...
#define PORT "23400"     // my UDP port, note that it is not an integer, please change it to the last five digits of your student ID
...
void serverEarlyRetrans( UdpSocket &sock, const int max, int message[], 
			 int windowSize );
void serverEarlyRetrans( UdpSocket &sock, const int max, int message[], 
			 int windowSize, int dropPercentage );
//void serverEarlyRetrans( UdpSocket &sock, const int max, int message[], 
